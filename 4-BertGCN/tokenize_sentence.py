...
def main():
    ...
    file_path = f"data/corpus/{args.dataset}_{args.target}.labels.txt"
    with open(file_path) as f:
        lines = f.readlines()
    titles = lines
    orig_titles = copy.deepcopy(titles)
    content_path = f"data/corpus/{args.dataset}_{args.target}.clean.txt"
    ...
    pickle.dump(matrix, open(f"data/pkl/{args.dataset}_{args.target}_matrix.pkl", 'wb'))
    pickle.dump(indexs, open(f"data/pkl/{args.dataset}_{args.target}_indexs.pkl", 'wb'))
    pickle.dump(train_index, open(f"data/pkl/{args.dataset}_{args.target}_train_index.pkl", 'wb'))
    pickle.dump(test_index, open(f"data/pkl/{args.dataset}_{args.target}_test_index.pkl", 'wb'))
    pickle.dump(valid_index, open(f"data/pkl/{args.dataset}_{args.target}_valid_index.pkl", 'wb'))
    pickle.dump(labels, open(f"data/pkl/{args.dataset}_{args.target}_labels.pkl", 'wb'))
    pickle.dump(dictonary, open(f"data/pkl/{args.dataset}_{args.target}_dict.pkl", 'wb'))
    pickle.dump(label_dict, open(f"data/pkl/{args.dataset}_{args.target}_label_dict.pkl", 'wb'))
